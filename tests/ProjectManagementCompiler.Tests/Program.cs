...
internal static class Program
{
    ...
    [
        ...
        ,("CarioXlsxGanttWorkbookContainsPreviewProvenanceMarkers", CarioXlsxTests.CarioXlsxGanttWorkbookContainsPreviewProvenanceMarkers)
        ,("ExistingTechnicalExportContractIsCharacterizedBeforeExecutiveExport", CarioXlsxTests.ExistingTechnicalExportContractIsCharacterizedBeforeExecutiveExport)
        ,("ExcelExportButtonNamesGanttWorkbook", GanttXlsxTests.ExcelExportButtonNamesGanttWorkbook)
        ,("PreviewWorkbookExportHasExplicitRoute", GanttXlsxTests.PreviewWorkbookExportHasExplicitRoute)
        ,("WorkbookExportSelectionKeepsPreviewOutOfOfficialRoute", GanttXlsxTests.WorkbookExportSelectionKeepsPreviewOutOfOfficialRoute)
        ,("CarioXlsxIncludesDailyGanttProjection", GanttXlsxTests.CarioXlsxIncludesDailyGanttProjection)
        ...
        ,("GanttMetadataColumnsUseCompactMenu", GanttUiRegressionTests.GanttMetadataColumnsUseCompactMenu)
        ,("GanttDependencyControlsExplainDirection", GanttUiRegressionTests.GanttDependencyControlsExplainDirection)
        ,("GanttSelectionOpensFocusedDependencies", GanttUiRegressionTests.GanttSelectionOpensFocusedDependencies)
        ,("GanttDependencyInspectorShowsImpact", GanttUiRegressionTests.GanttDependencyInspectorShowsImpact)
        ,("GanttDependencyImpactOffersProgressiveDisclosure", GanttUiRegressionTests.GanttDependencyImpactOffersProgressiveDisclosure)
        ...
        ,("ExistingTechnicalPreviewContractIsCharacterizedBeforeExecutiveExport", XlsxPreviewImporterTests.ExistingTechnicalPreviewContractIsCharacterizedBeforeExecutiveExport)
        ,("ProjectionUsesOfficialSourceDateAndApprovedTimelineSemantics", ExecutiveProgressProjectionTests.ProjectionUsesOfficialSourceDateAndApprovedTimelineSemantics)
        ,("ProjectionKeepsScheduleAndReadinessConditionsIndependent", ExecutiveProgressProjectionTests.ProjectionKeepsScheduleAndReadinessConditionsIndependent)
        ,("ProjectionUsesEvidenceSafeProgressAndSupportedStateCounts", ExecutiveProgressProjectionTests.ProjectionUsesEvidenceSafeProgressAndSupportedStateCounts)
        ...
        ,("DailyGanttFixtureBuildsOfficialSparseAndBoundaryEvidence", ExecutiveDailyGanttFixtureTests.DailyGanttFixtureBuildsOfficialSparseAndBoundaryEvidence)
        ,("DailyGanttFixtureSeparatesContradictoryAndNegativeEvidenceForFailClosedTests", ExecutiveDailyGanttFixtureTests.DailyGanttFixtureSeparatesContradictoryAndNegativeEvidenceForFailClosedTests)
        ...
        ,("ExecutiveWorkbookIdentifiesOfficialAuthority", ExecutiveProgressXlsxTests.ExecutiveWorkbookIdentifiesOfficialAuthority)
        ,("ExecutiveWorkbookHasExplicitEmptyAttentionStateAndBoundedOverview", ExecutiveProgressXlsxTests.ExecutiveWorkbookHasExplicitEmptyAttentionStateAndBoundedOverview)
        ,("ExecutiveWorkbookUsesProgressiveDisclosureRowsAndWeeklyAxis", ExecutiveProgressXlsxTests.ExecutiveWorkbookUsesProgressiveDisclosureRowsAndWeeklyAxis)
        ,("ExecutiveWorkbookConnectsTimelineRowsToWeeklyAxis", ExecutiveProgressXlsxTests.ExecutiveWorkbookConnectsTimelineRowsToWeeklyAxis)
        ,("ExecutiveWorkbookKeepsReportingMarkerVisibleOutsidePlanningBounds", ExecutiveProgressXlsxTests.ExecutiveWorkbookKeepsReportingMarkerVisibleOutsidePlanningBounds)
        ,("ExecutiveExportExposesAnIndependentCompilerSeam", ExecutiveProgressExportApplicationTests.ExecutiveExportExposesAnIndependentCompilerSeam)
        ,("ExecutiveExportUsesOfficialStateWithoutMutatingIt", ExecutiveProgressExportApplicationTests.ExecutiveExportUsesOfficialStateWithoutMutatingIt)
        ,("ExecutiveExportRejectsIncompleteOrNonOfficialResults", ExecutiveProgressExportApplicationTests.ExecutiveExportRejectsIncompleteOrNonOfficialResults)
        ,("ExecutiveExportEndpointUsesOfficialSelectionAndDatedDownloadContract", ExecutiveProgressExportApplicationTests.ExecutiveExportEndpointUsesOfficialSelectionAndDatedDownloadContract)
        ,("ExecutiveWorkbookIsPresentationOnlyAndCannotBecomePreviewOrSource", ExecutiveProgressExportApplicationTests.ExecutiveWorkbookIsPresentationOnlyAndCannotBecomePreviewOrSource)
        ,("UiExposesSeparateExecutiveAndTechnicalExportActions", ExecutiveProgressUiTests.UiExposesSeparateExecutiveAndTechnicalExportActions)
        ,("UiKeepsExecutiveExportOfficialOnlyAndPreviewSeparate", ExecutiveProgressUiTests.UiKeepsExecutiveExportOfficialOnlyAndPreviewSeparate)
        ,("UiKeepsOfficialExportAvailableWhilePreviewIsActive", ExecutiveProgressUiTests.UiKeepsOfficialExportAvailableWhilePreviewIsActive)
        ,("UiExportActionsRemainResponsiveAndAccessible", ExecutiveProgressUiTests.UiExportActionsRemainResponsiveAndAccessible)
        ...
        ,("CallerRowLimitCanOnlyTightenTheHardCeiling", XlsxPreviewImporterTests.CallerRowLimitCanOnlyTightenTheHardCeiling)
        ,("PreviewApiAndStateAreIsolatedFromOfficialResult", XlsxPreviewApplicationTests.PreviewApiAndStateAreIsolatedFromOfficialResult)
        ,("PreviewLifecycleKeepsOfficialAndProposalStateUntouched", XlsxPreviewApplicationTests.PreviewLifecycleKeepsOfficialAndProposalStateUntouched)
        ,("ValidPreviewDoesNotReplaceOfficialOrProposalProjection", XlsxPreviewApplicationTests.ValidPreviewDoesNotReplaceOfficialOrProposalProjection)
        ,("FailedPreviewImportLeavesLastValidPreviewUnchanged", XlsxPreviewApplicationTests.FailedPreviewImportLeavesLastValidPreviewUnchanged)
